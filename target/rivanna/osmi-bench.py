...
parser.add_argument("-h", "--haproxy_port", type=int, required=True, help="port for haproxy server")
parser.add_argument("-o", "--output_dir", type=str, required=True, help="directory to store output logs")
...
parser.add_argument("-t", "--tfs_base_port", type=int, required=True, help="base port for TF servers")
parser.add_argument("-g", "--ngpus", type=int, required=True, help="number of GPUs")
