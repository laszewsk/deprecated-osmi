...
parser.add_argument('--server', help='server ip, e.g. 10.1.1.37')
parser.add_argument('--batch', type=int, help='batch size')
parser.add_argument('--model', type=str, help='model name, e.g. small_lstm')
parser.add_argument('--nrequests', type=int, help='number of requests')
parser.add_argument("--haproxy_port", type=int, help="port for haproxy server")
parser.add_argument("--output_dir", type=str, help="directory to store output logs")
parser.add_argument("--config", type=str, help="model config file")
parser.add_argument("--tfs_base_port", type=int, help="base port for TF servers")
