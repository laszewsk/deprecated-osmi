...
def unique_base_port(config):
    ...
    # # 10
    # generated_id = experiment.repeat + experiment.concurrency*10 + experiment.ngpus*100 + np.log2(experiment.batch)*1000 # + d
    ...
    generated_id = (ngpus+1)*1000 + batch*100 + concurrency*10 + (repeat-1)*(ngpus+1)  
    # 57__
    # 47__
